...
var friendconnect_serverVersion = "0.545.6";
...
SHA1[fc].L=function(a){for(var b=this.Bc,c=0;c<64;c+=4){var d=a[c]<<24|a[c+1]<<16|a[c+2]<<8|a[c+3];b[c/4]=d}for(c=16;c<80;++c)b[c]=this.va(b[c-3]^b[c-8]^b[c-14]^b[c-16],1);a=this.c[0];d=this.c[1];var e=this.c[2],i=this.c[3],h=this.c[4],j,k;for(c=0;c<80;++c){if(c<40)if(c<20){j=i^d&(e^i);k=1518500249}else{j=d^e^i;k=1859775393}else if(c<60){j=d&e|i&(d|e);k=2400959708}else{j=d^e^i;k=3395469782}j=this.va(a,5)+j+h+k+b[c]&4294967295;h=i;i=e;e=this.va(d,30);d=a;a=j}this.c[0]=this.c[0]+a&4294967295;this.c[1]=
...
a^G_HMAC.IPAD}};G_HMAC.OPAD=92;G_HMAC.IPAD=54;G_HMAC[fc].reset=function(){this.k[fcwa]();this.k.update(this.Qb)};G_HMAC[fc].update=function(a){if(a.constructor!=Array)fca(new Error("Invalid data. Data must be an array."));this.k.update(a)};G_HMAC[fc].digest=function(){var a=this.k.digest();this.k[fcwa]();this.k.update(this.Rb);this.k.update(a);return this.k.digest()};G_HMAC[fc].Fb=function(a){this[fcwa]();this.update(a);return this.digest()};var fcIa=function(a){for(var b=[],c=0,d=0;d<a[fcr];d++){for(var e=a.charCodeAt(d);e>255;){b[c++]=e&255;e>>=8}b[c++]=e}return b};var fcJa=fcc,fcKa=fcc,fcLa=fcc,fcMa=fcc,fcOa=function(a,b){if(!fcEa(a))fca(Error("encodeByteArray takes an array as a parameter"));fcNa();b=b?fcLa:fcJa;for(var c=[],d=0;d<a[fcr];d+=3){var e=a[d],i=d+1<a[fcr],h=i?a[d+1]:0,j=d+2<a[fcr],k=j?a[d+2]:0,l=e>>2;e=(e&3)<<4|h>>4;h=(h&15)<<2|k>>6;k=k&63;if(!j){k=64;i||(h=64)}c[fcq](b[l],b[e],b[h],b[k])}return c[fcQ]("")},fcPa=function(a,b){if(a[fcr]%4)fca(Error("Length of b64-encoded data must be zero mod four"));fcNa();b=b?fcMa:fcKa;for(var c=[],d=0;d<a[fcr];d+=
4){var e=b[a[fcz](d)],i=b[a[fcz](d+1)],h=b[a[fcz](d+2)],j=b[a[fcz](d+3)];if(e==fcc||i==fcc||h==fcc||j==fcc)fca(Error());e=e<<2|i>>4;c[fcq](e);if(h!=64){i=i<<4&240|h>>2;c[fcq](i);if(j!=64){h=h<<6&192|j;c[fcq](h)}}}return c},fcNa=function(){if(!fcJa){fcJa={};fcKa={};fcLa={};fcMa={};for(var a=0;a<65;a++){fcJa[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="[fcz](a);fcKa[fcJa[a]]=a;fcLa[a]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_."[fcz](a);fcMa[fcLa[a]]=
a}}};var fcQa=function(a){return a[fcv](/^[\s\xa0]+|[\s\xa0]+$/g,"")},fcRa=function(a,b){a=fci(a)[fcAa]();b=fci(b)[fcAa]();return a<b?-1:a==b?0:1},fcXa=function(a,b){if(b)return a[fcv](fcSa,"&amp;")[fcv](fcTa,"&lt;")[fcv](fcUa,"&gt;")[fcv](fcVa,"&quot;");else{if(!fcWa[fcja](a))return a;if(a[fcC]("&")!=-1)a=a[fcv](fcSa,"&amp;");if(a[fcC]("<")!=-1)a=a[fcv](fcTa,"&lt;");if(a[fcC](">")!=-1)a=a[fcv](fcUa,"&gt;");if(a[fcC]('"')!=-1)a=a[fcv](fcVa,"&quot;");return a}},fcSa=/&/g,fcTa=/</g,fcUa=/>/g,fcVa=/\"/g,
fcWa=/[&<>\"]/,fcZa=function(a,b){var c=0;a=fcQa(fci(a))[fcx](".");b=fcQa(fci(b))[fcx](".");for(var d=fcl.max(a[fcr],b[fcr]),e=0;c==0&&e<d;e++){var i=a[e]||"",h=b[e]||"",j=new RegExp("(\\d*)(\\D*)","g"),k=new RegExp("(\\d*)(\\D*)","g");do{var l=j.exec(i)||["","",""],f=k.exec(h)||["","",""];if(l[0][fcr]==0&&f[0][fcr]==0)break;c=l[1][fcr]==0?0:fcaa(l[1],10);var g=f[1][fcr]==0?0:fcaa(f[1],10);c=fcYa(c,g)||fcYa(l[2][fcr]==0,f[2][fcr]==0)||fcYa(l[2],f[2])}while(c==0)}return c},fcYa=function(a,b){if(a<
b)return-1;else if(a>b)return 1;return 0};fcl[fcoa]()*2147483648|0;var fc_a,fc0a,fc1a,fc2a,fc3a,fc4a,fc5a,fc6a,fc7a,fc8a=function(){return fcS.navigator?fcS.navigator.userAgent:fcc},fc9a=function(){return fcS.navigator},fc$a=function(){fc3a=fc2a=fc1a=fc0a=fc_a=fcd;var a;if(a=fc8a()){var b=fc9a();fc_a=a[fcC]("Opera")==0;fc0a=!fc_a&&a[fcC]("MSIE")!=-1;fc2a=(fc1a=!fc_a&&a[fcC]("WebKit")!=-1)&&a[fcC]("Mobile")!=-1;fc3a=!fc_a&&!fc1a&&b.product=="Gecko"}};fc$a();
var fcab=fc_a,fcY=fc0a,fcbb=fc3a,fccb=fc1a,fcdb=fc2a,fceb=function(){var a=fc9a();return a&&a.platform||""},fcfb=fceb(),fcgb=function(){fc4a=fcfb[fcC]("Mac")!=-1;fc5a=fcfb[fcC]("Win")!=-1;fc6a=fcfb[fcC]("Linux")!=-1;fc7a=!!fc9a()&&(fc9a().appVersion||"")[fcC]("X11")!=-1};fcgb();
var fchb=function(){var a="",b;if(fcab&&fcS.opera){a=fcS.opera.version;a=typeof a=="function"?a():a}else{if(fcbb)b=/rv\:([^\);]+)(\)|;)/;else if(fcY)b=/MSIE\s+([^\);]+)(\)|;)/;else if(fccb)b=/WebKit\/(\S+)/;if(b)a=(a=b.exec(fc8a()))?a[1]:""}return a},fcib=fchb(),fcjb={},fckb=function(a){return fcjb[a]||(fcjb[a]=fcZa(fcib,a)>=0)};var fclb=/\s*;\s*/,fcmb=function(a,b,c,d,e){if(/[;=]/[fcja](a))fca(Error('Invalid cookie name "'+a+'"'));if(/;/[fcja](b))fca(Error('Invalid cookie value "'+b+'"'));fcBa(c)||(c=-1);e=e?";domain="+e:"";d=d?";path="+d:"";if(c<0)c="";else if(c==0){c=new Date(1970,1,1);c=";expires="+c.toUTCString()}else{c=new Date((new Date).getTime()+c*1E3);c=";expires="+c.toUTCString()}fck.cookie=a+"="+b+e+d+c},fcnb=function(a,b){a=a+"=";for(var c=fci(fck.cookie)[fcx](fclb),d=0,e;e=c[d];d++)if(e[fcC](a)==0)return e.substr(a[fcr]);
return b},fcob=function(a,b,c){var d=fcBa(fcnb(a));fcmb(a,"",0,b,c);return d};var fcZ=Array[fc],fcpb=fcZ[fcC]?function(a,b,c){return fcZ[fcC][fcF](a,b,c)}:function(a,b,c){c=c==fcc?0:c<0?fcl.max(0,a[fcr]+c):c;if(fcT(a)){if(!fcT(b)||b[fcr]!=1)return-1;return a[fcC](b,c)}for(c=c;c<a[fcr];c++)if(c in a&&a[c]===b)return c;return-1},fcqb=fcZ.forEach?function(a,b,c){fcZ.forEach[fcF](a,b,c)}:function(a,b,c){for(var d=a[fcr],e=fcT(a)?a[fcx](""):a,i=0;i<d;i++)i in e&&b[fcF](c,e[i],i,a)},fcrb=function(a,b){return fcpb(a,b)>=0},fcsb=function(){return fcZ.concat[fcL](fcZ,arguments)},fctb=
function(a){if(fcDa(a)=="array")return fcsb(a);else{for(var b=[],c=0,d=a[fcr];c<d;c++)b[c]=a[c];return b}},fcub=function(a,b,c){return arguments[fcr]<=2?fcZ[fcu][fcF](a,b):fcZ[fcu][fcF](a,b,c)};var fcvb=function(a,b){this.x=fcBa(a)?a:0;this.y=fcBa(b)?b:0};fcvb[fc].clone=function(){return new fcvb(this.x,this.y)};fcda(fcvb[fc],function(){return"("+this.x+", "+this.y+")"});var fc_=function(a,b){fcm(this,a);fco(this,b)};fc_[fc].clone=function(){return new fc_(this[fcs],this[fcO])};fcda(fc_[fc],function(){return"("+this[fcs]+" x "+this[fcO]+")"});fc_[fc].ceil=function(){fcm(this,fcl.ceil(this[fcs]));fco(this,fcl.ceil(this[fcO]));return this};fc_[fc].floor=function(){fcm(this,fcl.floor(this[fcs]));fco(this,fcl.floor(this[fcO]));return this};fc_[fc].round=function(){fcm(this,fcl[fct](this[fcs]));fco(this,fcl[fct](this[fcO]));return this};
fc_[fc].scale=function(a){this.width*=a;this.height*=a;return this};var fcwb=function(a,b,c){for(var d in a)b[fcF](c,a[d],d,a)},fcxb=function(a){var b=[],c=0;for(var d in a)b[c++]=a[d];return b},fcyb=function(a){var b=[],c=0;for(var d in a)b[c++]=d;return b},fczb=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"],fcAb=function(a){for(var b,c,d=1;d<arguments[fcr];d++){c=arguments[d];for(b in c)a[b]=c[b];for(var e=0;e<fczb[fcr];e++){b=fczb[e];if(fcca[fc].hasOwnProperty[fcF](c,b))a[b]=c[b]}}};var fcBb=function(a){return(a=a.className)&&typeof a[fcx]=="function"?a[fcx](/\s+/):[]},fcDb=function(a){var b=fcBb(a),c=fcub(arguments,1);c=fcCb(b,c);fcfa(a,b[fcQ](" "));return c},fcCb=function(a,b){for(var c=0,d=0;d<b[fcr];d++)if(!fcrb(a,b[d])){a[fcq](b[d]);c++}return c==b[fcr]};var fcEb=function(a){return fcT(a)?fck[fcy](a):a},fcFb=fcEb,fcGb=function(a,b,c,d){d=d||a;b=b&&b!="*"?b.toUpperCase():"";if(d.querySelectorAll&&(b||c)&&(!fccb||a.compatMode=="CSS1Compat"||fckb("528"))){c=b+(c?"."+c:"");return d.querySelectorAll(c)}if(c&&d.getElementsByClassName){a=d.getElementsByClassName(c);if(b){d={};for(var e=0,i=0,h;h=a[i];i++)if(b==h.nodeName)d[e++]=h;fcea(d,e);return d}else return a}a=d.getElementsByTagName(b||"*");if(c){d={};for(i=e=0;h=a[i];i++){b=h.className;if(typeof b[fcx]==
"function"&&fcrb(b[fcx](/\s+/),c))d[e++]=h}fcea(d,e);return d}else return a},fcIb=function(a,b){fcwb(b,function(c,d){if(d=="style")a[fcD].cssText=c;else if(d=="class")fcfa(a,c);else if(d=="for")a.htmlFor=c;else if(d in fcHb)a[fcJ](fcHb[d],c);else a[d]=c})},fcHb={cellpadding:"cellPadding",cellspacing:"cellSpacing",colspan:"colSpan",rowspan:"rowSpan",valign:"vAlign",height:"height",width:"width",usemap:"useMap",frameborder:"frameBorder",type:"type"},fcJb=function(a){var b=a[fcw];if(fccb&&!fckb("500")&&
!fcdb){if(typeof a.innerHeight=="undefined")a=fcj;b=a.innerHeight;var c=a[fcw].documentElement.scrollHeight;if(a==a.top)if(c<b)b-=15;return new fc_(a.innerWidth,b)}a=b.compatMode=="CSS1Compat"&&(!fcab||fcab&&fckb("9.50"))?b.documentElement:b[fcna];return new fc_(a.clientWidth,a.clientHeight)},fc0=function(){return fcKb(fck,arguments)},fcKb=function(a,b){var c=b[0],d=b[1];if(fcY&&d&&(d[fcM]||d[fcua])){c=["<",c];d[fcM]&&c[fcq](' name="',fcXa(d[fcM]),'"');if(d[fcua]){c[fcq](' type="',fcXa(d[fcua]),'"');
d=fcU(d);delete d[fcua]}c[fcq](">");c=c[fcQ]("")}var e=a[fcI](c);if(d)if(fcT(d))fcfa(e,d);else fcIb(e,d);if(b[fcr]>2){d=function(h){if(h)e[fcp](fcT(h)?a.createTextNode(h):h)};for(c=2;c<b[fcr];c++){var i=b[c];fcEa(i)&&!(fcFa(i)&&i.nodeType>0)?fcqb(fcLb(i)?fctb(i):i,d):d(i)}}return e},fcMb=function(a,b){a[fcp](b)},fcNb=function(a){return a&&a[fcN]?a[fcN].removeChild(a):fcc},fcOb=function(a,b){var c=b[fcN];c&&c.replaceChild(a,b)},fcPb=function(a,b){if(a.contains&&b.nodeType==1)return a==b||a.contains(b);
if(typeof a.compareDocumentPosition!="undefined")return a==b||Boolean(a.compareDocumentPosition(b)&16);for(;b&&a!=b;)b=b[fcN];return b==a},fcLb=function(a){if(a&&typeof a[fcr]=="number")if(fcFa(a))return typeof a.item=="function"||typeof a.item=="string";else if(fcDa(a)=="function")return typeof a.item=="function";return fcd},fcQb=function(a){this.tb=a||fcS[fcw]||fck};fcQb[fc].createElement=function(a){return this.tb[fcI](a)};fcQb[fc].createTextNode=function(a){return this.tb.createTextNode(a)};
fcQb[fc].appendChild=fcMb;fcQb[fc].removeNode=fcNb;fcQb[fc].replaceNode=fcOb;fcQb[fc].contains=fcPb;var fcRb="StopIteration"in fcS?fcS.StopIteration:Error("StopIteration"),fcSb=function(){};fcSb[fc].next=function(){fca(fcRb)};fcSb[fc].__iterator__=function(){return this};var fc1=function(a){this.i={};this.e=[];var b=arguments[fcr];if(b>1){if(b%2)fca(Error("Uneven number of arguments"));for(var c=0;c<b;c+=2)this.set(arguments[c],arguments[c+1])}else a&&this.jb(a)};fc1[fc].q=0;fc1[fc].J=0;fc1[fc].Ka=function(){return this.q};fc1[fc].ja=function(){this.K();for(var a=[],b=0;b<this.e[fcr];b++){var c=this.e[b];a[fcq](this.i[c])}return a};fc1[fc].P=function(){this.K();return this.e.concat()};fc1[fc].qb=function(a){return fcTb(this.i,a)};
fc1[fc].clear=function(){this.i={};fcea(this.e,0);this.J=this.q=0};fc1[fc].remove=function(a){if(fcTb(this.i,a)){delete this.i[a];this.q--;this.J++;this.e[fcr]>2*this.q&&this.K();return fcb}return fcd};fc1[fc].K=function(){if(this.q!=this.e[fcr]){for(var a=0,b=0;a<this.e[fcr];){var c=this.e[a];if(fcTb(this.i,c))this.e[b++]=c;a++}fcea(this.e,b)}if(this.q!=this.e[fcr]){var d={};for(b=a=0;a<this.e[fcr];){c=this.e[a];if(!fcTb(d,c)){this.e[b++]=c;d[c]=1}a++}fcea(this.e,b)}};
fc1[fc].get=function(a,b){if(fcTb(this.i,a))return this.i[a];return b};fc1[fc].set=function(a,b){if(!fcTb(this.i,a)){this.q++;this.e[fcq](a);this.J++}this.i[a]=b};fc1[fc].jb=function(a){var b;if(a instanceof fc1){b=a.P();a=a.ja()}else{b=fcyb(a);a=fcxb(a)}for(var c=0;c<b[fcr];c++)this.set(b[c],a[c])};fc1[fc].clone=function(){return new fc1(this)};
fc1[fc].__iterator__=function(a){this.K();var b=0,c=this.e,d=this.i,e=this.J,i=this,h=new fcSb;h.next=function(){for(;;){if(e!=i.J)fca(Error("The map has changed since the iterator was created"));if(b>=c[fcr])fca(fcRb);var j=c[b++];return a?j:d[j]}};return h};var fcTb=function(a,b){return fcca[fc].hasOwnProperty[fcF](a,b)};var fcUb=function(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d};fcUb[fc].clone=function(){return new fcUb(this.top,this[fcR],this[fcra],this[fcE])};fcda(fcUb[fc],function(){return"("+this.top+"t, "+this[fcR]+"r, "+this[fcra]+"b, "+this[fcE]+"l)"});fcUb[fc].contains=function(a){return fcVb(this,a)};fcUb[fc].expand=function(a,b,c,d){if(fcFa(a)){this.top-=a.top;this.right+=a[fcR];this.bottom+=a[fcra];this.left-=a[fcE]}else{this.top-=a;this.right+=b;this.bottom+=c;this.left-=d}return this};
var fcVb=function(a,b){if(!a||!b)return fcd;if(b instanceof fcUb)return b[fcE]>=a[fcE]&&b[fcR]<=a[fcR]&&b.top>=a.top&&b[fcra]<=a[fcra];return b.x>=a[fcE]&&b.x<=a[fcR]&&b.y>=a.top&&b.y<=a[fcra]};var fcWb=function(a,b,c,d){this.left=a;this.top=b;fcm(this,c);fco(this,d)};fcWb[fc].clone=function(){return new fcWb(this[fcE],this.top,this[fcs],this[fcO])};fcda(fcWb[fc],function(){return"("+this[fcE]+", "+this.top+" - "+this[fcs]+"w x "+this[fcO]+"h)"});fcWb[fc].contains=function(a){return a instanceof fcWb?this[fcE]<=a[fcE]&&this[fcE]+this[fcs]>=a[fcE]+a[fcs]&&this.top<=a.top&&this.top+this[fcO]>=a.top+a[fcO]:a.x>=this[fcE]&&a.x<=this[fcE]+this[fcs]&&a.y>=this.top&&a.y<=this.top+this[fcO]};var fcYb=function(a,b,c){fcT(b)?fcXb(a,c,b):fcwb(b,fcGa(fcXb,a))},fcXb=function(a,b,c){a[fcD][fcZb(c)]=b},fc_b=function(a,b){var c=a.nodeType==9?a:a.ownerDocument||a[fcw];if(c.defaultView&&c.defaultView.getComputedStyle)if(a=c.defaultView.getComputedStyle(a,""))return a[b];return fcc},fc0b=function(a,b,c){if(b instanceof fc_){c=b[fcO];b=b[fcs]}else{if(c==fcf)fca(Error("missing height argument"));c=c}fcm(a[fcD],typeof b=="number"?fcl[fct](b)+"px":b);fco(a[fcD],typeof c=="number"?fcl[fct](c)+"px":c)},
fc1b=function(a){var b=fcab&&!fckb("10");if((fc_b(a,"display")||(a.currentStyle?a.currentStyle[fcya]:fcc)||a[fcD][fcya])!="none")return b?new fc_(a[fcla]||a.clientWidth,a[fcza]||a.clientHeight):new fc_(a[fcla],a[fcza]);var c=a[fcD],d=c[fcya],e=c.visibility,i=c.position;c.visibility="hidden";c.position="absolute";c.display="inline";if(b){b=a[fcla]||a.clientWidth;a=a[fcza]||a.clientHeight}else{b=a[fcla];a=a[fcza]}c.display=d;c.position=i;c.visibility=e;return new fc_(b,a)},fc2b={},fcZb=function(a){return fc2b[a]||
(fc2b[a]=fci(a)[fcv](/\-([a-z])/g,function(b,c){return c.toUpperCase()}))},fc3b=function(a,b){a[fcD].display=b?"":"none"};var fc4b={},fc5b={};var fc6b=function(a,b,c,d){b=b||"800";c=c||"550";d=d||"friendconnect";a=fcj.open(a,d,"menubar=no,toolbar=no,dialog=yes,location=yes,alwaysRaised=yes,width="+b+",height="+c+",resizable=yes,scrollbars=1,status=1");fcj.focus&&a&&a.focus()},fc7b=function(a,b){var c=fce[fcK][fcB]().communityId;fce.rpc[fcF](fcc,"signin",fcc,c,a,b)};fcW("goog.peoplesense.util.openPopup",fc6b);fcW("goog.peoplesense.util.finishSignIn",fc7b);var fc$b=function(a,b){var c=fc8b()+"/friendconnect/invite/friends",d=fch(shindig[fcva][fcxa]());fc9b(c,d,a,b)},fc9b=function(a,b,c,d){a+="?st="+b;if(c)a+="&customMessage="+fch(c);if(d)a+="&customInviteUrl="+fch(d);b=760;if(fcY)b+=25;fc6b(a,fci(b),"515","friendconnect_invite")};fcW("goog.peoplesense.util.invite",fc$b);fcW("goog.peoplesense.util.inviteFriends",fc9b);var fcac=function(a){this.url=a};fcac[fc].l=function(a,b){if(this.url[fcC]("?"+a+"=")>=0||this.url[fcC]("&"+a+"=")>=0)fca(new Error("duplicate: "+a));if(b===fcc||b===fcf)return this;var c=this.url[fcC]("?")>=0?"&":"?";this.url+=c+a+"="+fch(b);return this};fcda(fcac[fc],function(){return this.url});var fc8b=function(){return fcj.friendconnect_serverBase},fcbc=function(a,b,c,d,e,i,h){b=b||"800";c=c||"550";d=d||"friendconnect";i=i||fcd;fce.rpc[fcF](fcc,"openLightboxIframe",h,a,shindig[fcva][fcxa](),b,c,d,e,fcc,fcc,fcc,i)},fccc=function(a,b){var c=fce[fcK][fcB]().psinvite||"",d=new fcac(fc8b()+"/friendconnect/signin/home");d.l("st",fcj.shindig[fcva][fcxa]());d.l("psinvite",c);d.l("iframeId",a);d.l("loginProvider",b);d.l("subscribeOnSignin","1");fc6b(d[fcga]());return fcd},fcdc=function(){var a=
fce[fcK][fcB]().communityId;fce.rpc[fcF](fcc,"signout",fcc,a)},fcfc=function(a,b){a=fc8b()+"/friendconnect/settings/edit?st="+fch(shindig[fcva][fcxa]())+(a?"&iframeId="+fch(a):"");if(b)a=a+"&"+b;fcec(a)},fcgc=function(a){a=fc8b()+"/friendconnect/settings/siteProfile?st="+fch(a);fcec(a)},fcec=function(a){var b=800,c=510;if(fcY)b+=25;fc6b(a,fci(b),fci(c))},fchc=function(a,b,c,d){d=d||2;var e=fcc;if(b=="text"){e=fc0("div",{"class":"gfc-button-text"},fc0("div",{"class":"gfc-icon"},fc0("a",{href:"javascript:void(0);"},
...
cellpadding:"0",cellspacing:"0"},fc0("tbody",{"class":""},fc0("tr",{"class":""},fc0("td",{"class":"gfc-button-base-v2 gfc-button-1"}),fc0("td",{"class":"gfc-button-base-v2 gfc-button-2"},c),fc0("td",{"class":"gfc-button-base-v2 gfc-button-3"}))));a[fcp](e);if(b=="standard"){b=fc0("div",{"class":"gfc-footer-msg"},"with Google Friend Connect");d==1&&a[fcp](fc0("br"));a[fcp](b)}}return e},fcic=function(a,b){if(!a)fca("google.friendconnect.renderSignInButton: missing options");var c=a[fcD]||"standard",
d=a.text,e=a.version;if(c=="standard")d=a.text||"Sign in";else if(c=="text"||c=="long")d=a.text||"Sign in with Friend Connect";var i=a.element;if(!i){i=a.id;if(!i)fca("google.friendconnect.renderSignInButton: options[id] and options[element] == null");i=fcFb(i);if(!i)fca("google.friendconnect.renderSignInButton: element "+a.id+" not found")}fcn(i,"");a=fchc(i,c,d,e);fcj[fcqa]?a[fcqa]("click",b,fcd):a.attachEvent("onclick",b)},fcjc=function(a,b){b=b||fcV(fccc,fcc,fcc,fcc,fcc);fcic(a,b)},fckc=function(a,
b){fce.rpc[fcF](fcc,"putReloadViewParam",fcc,a,b);var c=fce.views.getParams();c[a]=b},fclc=function(a,b){var c=new fcac("/friendconnect/gadgetshare/friends");c.l("customMessage",a);c.l("customInviteUrl",b);c.l("container","glb");a=310;if(fcY)a+=25;fcbc(c[fcga](),fci(a),"370")};fcW("goog.peoplesense.util.getBaseUrl",fc8b);fcW("goog.peoplesense.util.finishSignIn",fc7b);fcW("goog.peoplesense.util.signout",fcdc);fcW("goog.peoplesense.util.signin",fccc);fcW("goog.peoplesense.util.editSettings",fcfc);
fcW("goog.peoplesense.util.editSSProfile",fcgc);fcW("goog.peoplesense.util.setStickyViewParamToken",fckc);fcW("google.friendconnect.renderSignInButton",fcjc);fcW("goog.peoplesense.util.share",fclc);fcW("goog.peoplesense.util.userAgent.IE",fcY);var fcmc={},fcnc={},fc2=function(a){this.h=new fc1;this.snippetId=a.id;this.site=a.site;a=a["view-params"];var b=a.skin;this.bc=(b?b.POSITION:"top")||"top";this.Cc={allowAnonymousPost:a.allowAnonymousPost||fcd,scope:a.scope||"SITE",docId:a.docId||"",features:a.features||"video,comment",startMaximized:"true",disableMinMax:"true",skin:b};this.absoluteBottom=fcY&&!fckb("7");this.fixedIeSizes=fcY;fcj[fcqa]?fcj[fcqa]("resize",fcV(this.$a,this),fcd):fcj.attachEvent("onresize",fcV(this.$a,this));this.ob()};
fc2[fc].ob=function(){if(!this.site)fca(new Error("Must supply site ID."));if(!this.snippetId)fca(new Error("Must supply a snippet ID."))};fc2[fc].b=10;fc2[fc].za=1;fc2[fc].p="fc-friendbar-";fc2[fc].t=fc2[fc].p+"outer";fc2[fc].cb=fc2[fc].t+"-shadow";fc2[fc].render=function(){fck.write(this.xb());var a=fcEb(this.snippetId);fcn(a,this.N())};fc2[fc].yb=function(){var a=fcEb(this.t);return a=fc1b(a)[fcs]};
fc2[fc].$a=function(){for(var a=this.h.P(),b=0;b<a[fcr];b++)this.nc(a[b]);goog&&fc4b&&fc5b&&fcoc&&fcpc("resize")};fc2[fc].n=function(){return this.bc};fc2[fc].d=function(a){return this.p+"shadow-"+a};fc2[fc].ha=function(a){return this.p+"menus-"+a};fc2[fc].Q=function(a){return this.p+a+"Target"};fc2[fc].fa=function(a){return this.p+a+"Drawer"};fc2[fc].Pa=function(){return this.Q("")};fc2[fc].Qa=function(){return this.p+"wallpaper"};fc2[fc].La=function(){return this.fa("")};
...
c;if(this.n()!="top")l=b;var f=0,g=[];g[f++]='<style type="text/css">';if(this.n()!="top"&&this.absoluteBottom)g[f++]="html, body {height: 100%; overflow: auto; };";g[f++]="#"+this.t+" {";g[f++]="background:#E0ECFF;";g[f++]="left:0;";g[f++]="height: "+(fcY?"35px;":"36px;");if(this.n()!="top"&&this.absoluteBottom)g[f++]="margin-right: 20px;";g[f++]="padding:0;";g[f++]=k+" 0;";g[f++]="width:100%;";g[f++]="z-index:5000;";g[f++]="}";g[f++]="#"+this.cb+" {";g[f++]=j(l,"repeat-x");g[f++]="left:0;";g[f++]=
"height:"+this.b+"px;";if(this.n()!="top"&&this.absoluteBottom)g[f++]="margin-right: 20px;";g[f++]="padding:0;";g[f++]=k+(fcY?"35px;":"36px;");g[f++]="width:100%;";g[f++]="z-index:4998;";g[f++]="}";g[f++]="."+this.La()+" {";g[f++]="display: block;";g[f++]="padding:0;";g[f++]=k+(fcY?"34px;":"35px;");g[f++]="z-index:4999;";g[f++]="}";g[f++]="."+this.Qa()+" {";g[f++]="background: white;";g[f++]="height: 100%;";g[f++]="margin-right: "+this.b+"px;";g[f++]="}";g[f++]="."+this.Pa()+" {";g[f++]="border: "+
...
fc2[fc].N=function(){var a=['<div id="'+this.t+'"></div>','<div id="'+this.cb+'"></div>','<div id="'+this.ha(this.h.Ka())+'"></div>'];return a[fcQ]("")};fc2[fc].rb=function(a,b,c,d){if(!this.h.qb(a)){b=new fc3(this,a,b,c,d);c=this.h.Ka();d=fcEb(this.ha(c));fcn(d,b.N()+'<div id="'+this.ha(c+1)+'"></div>');this.h.set(a,b)}};fc2[fc].la=function(a){(a=this.h.get(a))&&a.drawer&&fc3b(a.drawer,fcd)};fc2[fc].dc=function(a){if(a=this.h.get(a))a.rendered=fcd};
...
fc2[fc].yc=function(a,b){var c=this.h.get(a);if(c){if(!c.drawer){c.drawer=fcEb(this.fa(c[fcM]));c.target=fcEb(this.Q(c[fcM]));c.sha_bc=fcGb(fck,"div",this.n()=="top"?this.d("bc"):this.d("tc"),c.drawer)[0];c.sha_cr=fcGb(fck,"div",this.d("cr"),c.drawer)[0]}for(var d=this.h.P(),e=0;e<d[fcr];e++){var i=d[e];a!==i&&this.la(i)}c.da(b);fc3b(c.drawer,fcb);fcj.setTimeout(function(){c.ya();c.Ha();c.render()},0)}};
...
fc3[fc].da=function(a){fcAb(this.constraints,a||{});fcAb(this.skin,this.constraints);if(this.bar.fixedIeSizes&&this.constraints[fcE]&&this.constraints[fcR]){a=this.bar.yb();var b=this.constraints[fcE],c=this.constraints[fcR];a=a-(b+c);if(a%2){a-=1;this.skin.right+=1}fcm(this.skin,a);delete this.skin[fcE]}};
fc3[fc].ya=function(){if(this.drawer){if(this.skin[fcs]){var a=this.bar.za,b=this.bar.b,c=fcY?2:0;fc0b(this.target,this.skin[fcs],"");fc0b(this.sha_bc,this.skin[fcs]-b+2*a-c,"");this.skin.rightShadow?fc0b(this.drawer,this.skin[fcs]+b+2*a-c,""):fc0b(this.drawer,this.skin[fcs]+2*a-c,"")}if(this.skin[fcR])this.drawer[fcD].right=this.skin[fcR]+0+"px"}};
fc3[fc].Ha=function(){if(fcY&&this.drawer){var a=fc1b(this.target),b=a[fcs]-this.bar.b;a=a[fcO];if(b<0)b=0;this.sha_bc&&this.sha_bc[fcD]&&fc0b(this.sha_bc,b,"");this.sha_cr&&this.sha_cr[fcD]&&fc0b(this.sha_cr,"",a)}};
fc3[fc].N=function(){var a="display:none;",b="position: relative; ",c="",d="",e="",i="",h=!!this.skin.rightShadow;if(!h){c+="display: none; ";e+="display: none; ";d+="right: 0px; ";i+="margin-right: 0px; "}for(var j in this.skin){var k=Number(this.skin[j]);if(h&&fcRa(j,"width")==0)k+=this.bar.b;if(fcRa(j,"height")==0)b+=j+": "+k+"px; ";if(j!="rightShadow"){if(fcRa(j,"height")==0)k+=this.bar.b;if(fcRa(j,"width")==0)k+=2;a+=j+": "+k+"px; "}if(fcY&&fcRa(j,"width")==0){k-=h?2*this.bar.b:this.bar.b;d+=
j+": "+k+"px; "}}if(fcY&&(this[fcO]|0)>0){h=(this[fcO]|0)+2;c+="height: "+h+"px; "}h=0;j=[];j[h++]='<div id="'+this.bar.fa(this[fcM])+'"class="'+this.bar.La()+'"style="'+a+'"> ';if(this.bar.n()=="bottom")j[h++]='<div class="'+this.bar.d("tl")+'"></div> <div class="'+this.bar.d("tc")+'"style="'+d+'"></div> <div class="'+this.bar.d("tr")+'"style="'+e+'"></div> ';j[h++]='<div style="'+b+'"> <div class="'+this.bar.Qa()+'"style="'+i+'"><div id="'+this.bar.Q(this[fcM])+'"class="'+this.bar.Pa()+'"></div> <div class="'+
this.bar.d("cr")+'"style="'+c+'"></div> </div> </div> ';if(this.bar.n()=="top")j[h++]='<div class="'+this.bar.d("bl")+'"></div> <div class="'+this.bar.d("bc")+'"style="'+d+'"></div> <div class="'+this.bar.d("br")+'"style="'+e+'"></div> ';j[h++]="</div> ";return j[fcQ]("")};fc3[fc].zc=function(){this.rendered=this.na()};fc3[fc].Ub=function(){this.loaded=this.na()};fc3[fc].na=function(){return!!this.drawer&&this.drawer[fcD][fcya]!="none"};
fc3[fc].render=function(){if(this.rendered==fcd){var a={};a.url=this.url;a.id=this.bar.Q(this[fcM]);a.site=this.bar.site;a["view-params"]=fcU(this.bar.Cc);if(this[fcM]=="profile")a["view-params"].profileId="VIEWER";this.skin&&fcAb(a["view-params"].skin,this.skin);a["view-params"].menuName=this[fcM];a["view-params"].opaque="true";a["view-params"].menuPosition=this.bar.bc;fco(a,"1px");if(fcmc&&fcnc&&fc4)this.id=fc4.render(a)}};fcW("google.friendconnect.FriendBar",fc2);var fcqc="0123456789abcdefghijklmnopqrstuv",fcsc=function(a){a=new fcrc(a);if(a.pa()%5)fca(Error());for(var b=[],c=0;a.pa()>0;c++)b[c]=fcqc[fcz](a.$b(5));return b[fcQ]("")},fcrc=function(a){this.D=this.r=0;this.ca=a};fcrc[fc].pa=function(){return 8*(this.ca[fcr]-this.D)-this.r};
fcrc[fc].$b=function(a){var b=0;if(a>this.pa())fca(Error());if(this.r>0){b=255>>this.r&this.ca[this.D];var c=8-this.r,d=fcl.min(a%8,c);c=c-d;b=b>>c;a-=d;this.r+=d;if(this.r==8){this.r=0;this.D++}}for(;a>=8;){b<<=8;b|=this.ca[this.D];this.D++;a-=8}if(a>0){b<<=a;b|=this.ca[this.D]>>8-a;this.r=a}return b};var fctc=function(){};fctc[fc].F=function(){};fctc[fc].I=function(){};var fcuc=(new Date).getTime(),fc5=function(){},fcvc=function(){},fcwc=function(){},fcxc=function(){};fcX(fcxc,fcwc);var fcyc=function(a){if(a)for(var b in a)if(a.hasOwnProperty(b))this[b]=a[b];if(this.viewParams)for(var c in this.viewParams)if(/^FC_RELOAD_.*$/[fcja](c))this.viewParams[c]=fcc};fcyc[fc].render=function(a){var b=this;if(a){b.Ac();this.Ab(function(c){fcYb(a,"visibility","hidden");fcn(a,c);b.refresh(a,c);c=function(d){fcYb(d,"visibility","visible")};c=fcGa(c,a);fcba(c,500);b.chrome=a})}};
fcyc[fc].Ab=function(a){return this.Gb(a)};var fc6=function(a){fcyc[fcF](this,a);this.U="../../";this.rpcToken=fci(fcl[fct](2147483647*fcl[fcoa]()))};fcX(fc6,fcyc);fc6[fc].hb="gfc_iframe_";fc6[fc].ib="friendconnect";fc6[fc].Ia="";fc6[fc].oc="rpc_relay.html";fc6[fc].X=function(a){this.U=a};fc6[fc].Ac=function(){return this.Ia=fci(fcl[fct](2147483647*fcl[fcoa]()))};fc6[fc].ga=function(){return this.hb+this.Ia+"_"+this.id};
fc6[fc].refresh=function(a,b){var c=fc4.Fc,d,e={},i=fc4.Ja(this.communityId),h=i[fcx]("~"),j=fc4.sb;if(j&&h[fcr]>1){d=h[2];h=h[1];var k=[this.specUrl,this.communityId,h,j][fcQ](":");e.sig=fc4.hash(d,k);e.userId=h;e.dateStamp=j}e.container=this.ib;e.mid=this.id;e.nocache=fc4.ac;e.view=this.Z;e.parent=fc4.S;if(this.debug)e.debug="1";if(this.specUrl)e.url=this.specUrl;if(this.communityId){j=fce[fcK][fcB]().profileId;e.communityId=this.communityId;if(d=fce[fcK][fcB]().psinvite)e.psinvite=d;if(j)e.profileId=
j}e.caller=fczc();e.rpctoken=this.rpcToken;j=fcd;d="";h=/Version\/3\..*Safari/;if((h=fccb&&fc8a()[fcG](h))||!fc4.R[this.specUrl]&&this.viewParams){e["view-params"]=fce[fcpa][fcia](this.viewParams);d="?viewParams="+fch(e["view-params"]);j=fcb}if(this.prefs)e.prefs=fce[fcpa][fcia](this.prefs);if(this.viewParams&&this.sendViewParamsToServer)e["view-params"]=fce[fcpa][fcia](this.viewParams);if(this.locale)e.locale=this.locale;if(this.secureToken)e.st=this.secureToken;h=fc4.Oa(this.specUrl);d=h+"ifr"+
d+(this.hashData?"&"+this.hashData:"");if(fc4.Ec!=1||j||i||this.secureToken){if(i&&!e.sig)e.fcauth=i}else e.sig||(c="get");i=this.ga();fcAc(i,d,c,e,a,b,this.rpcToken)};var fc7=function(){this.j={};this.S="http://"+fck[fcA].host;this.Z="default";this.ac=1;this.Jc=0;this.Gc="US";this.Hc="en";this.Ic=2147483647};fcX(fc7,fcvc);fc7[fc].v=fcyc;fc7[fc].A=new fcxc;fc7[fc].bb=function(a){this.ac=a};fc7[fc].Ga=function(a){this.Ec=a};fc7[fc].Na=function(a){return"gadget_"+a};fc7[fc].w=function(a){return this.j[this.Na(a)]};
fc7[fc].M=function(a){return new this.v(a)};fc7[fc].kb=function(a){a.id=this.Hb();this.j[this.Na(a.id)]=a};fc7[fc].Zb=0;fc7[fc].Hb=function(){return this.Zb++};var fcCc=function(){fc7[fcF](this);this.A=new fcBc};fcX(fcCc,fc7);fcCc[fc].v=fc6;fcCc[fc].W=function(a){a[fcG](/^http[s]?:\/\//)||(a=fck[fcA][fcsa][fcG](/^[^?#]+\//)[0]+a);this.S=a};fcCc[fc].H=function(a){var b=this.A.Ma(a);a.render(b)};var fcBc=function(){this.wb={}};fcX(fcBc,fcwc);
fcBc[fc].lb=function(a,b){this.wb[a]=b;a=fck[fcy](b).className;if(!a&&a[fcr]==0)fcfa(fck[fcy](b),"gadgets-gadget-container")};fcBc[fc].Ma=function(a){return(a=this.wb[a.id])?fck[fcy](a):fcc};var fc8=function(a){fc6[fcF](this,a);a=a||{};this.Z=a.view||"profile"};fcX(fc8,fc6);fc8[fc].nb="canvas.html";fc8[fc].ub="/friendconnect/embed/";
...
fc8[fc].zb=function(){var a=fczc();a="canvas=1&caller="+fch(a);var b=fce[fcK][fcB]().psinvite;if(b)a+="&psinvite="+fch(b);a+="&site="+fch(this.communityId);b=fcU(this.viewParams);if(b.skin!=fcc)for(var c=["BG_IMAGE","BG_COLOR","FONT_COLOR","BG_POSITION","BG_REPEAT","ANCHOR_COLOR","FONT_FACE","BORDER_COLOR","CONTENT_BG_COLOR","CONTENT_HEADLINE_COLOR","CONTENT_LINK_COLOR","CONTENT_SECONDARY_TEXT_COLOR","CONTENT_SECONDARY_LINK_COLOR","CONTENT_TEXT_COLOR","ENDCAP_BG_COLOR","ENDCAP_LINK_COLOR","ENDCAP_TEXT_COLOR",
...
fce.rpc[fcP]("getContainerBaseTime",fc5[fc].Ea);fce.rpc[fcP]("openLightboxIframe",fc5[fc].Ua);fce.rpc[fcP]("showMemberProfile",fc5[fc].fb);fce.rpc[fcP]("closeLightboxIframe",fcV(this.u,this));fce.rpc[fcP]("setLightboxIframeTitle",fcV(this.sc,this));fce.rpc[fcP]("refreshAndCloseIframeLightbox",fcV(this.cc,this));var a=fcDc;a[fcP]();a.gb(this,"load",this.Nb);a.gb(this,"start",this.Ob);this.U="../../";this.W("");this.bb(0);this.Ga(1);this.oa=fcc;this.apiVersion="0.8";this.openSocialSecurityToken=fcc;
this.V="";this.Da={};this.Tb=fcc;this.Sb=fcd;this.sb=this.Wb=this.lastIframeLightboxOpenArguments=this.lastLightboxCallback=this.lastLightboxDialog=fcc;this.Fc="post"};fcX(fc9,fcCc);fc9[fc].qc=function(a){this.sb=a};fc9[fc].v=fc8;fc9[fc].R={};fc9[fc].uc=function(a){this.oa=a};fc9[fc].Oa=function(a){var b=fc9[fc].R[a];if(!b)if(this.oa[fcC]("http://")!==0){a=this.pb(a);b=["http://",a,this.oa][fcQ]("")}else b=this.oa;return b};
fc9[fc].pb=function(a){var b=new SHA1;a=fcIa(a);b.update(a);b=b.digest();return b=fcsc(b)};
...
fc9[fc].cc=function(){this.u();this.T()};fc5[fc].Za=function(a,b){var c=fc$(this.f);c=fc4.w(c);var d=fcU(c.originalParams);if(b){d["view-params"]=d["view-params"]||{};d["view-params"]=b}d.locale=c.locale;if(c.useLightBoxForCanvas){d.presentation=a;fc4.lastLightboxDialog!=fcc?fc4.u():fc4.eb(d)}else if((a=c.Lb(a))&&fck[fcA][fcsa]!=a)if(fce[fcK][fcB]().embed=="1")try{fcj.parent.location=a}catch(e){fcj.top.location=a}else fck[fcA].href=a};
fc9[fc].eb=function(a,b){a=a||{};var c=a.locale,d=fcFc(c),e=this;this.u();this.Y(function(i){var h=fc0("div",{},fc0("div",{id:"gadget-signin",style:"background-color:#ffffff;height:32px;"}),fc0("div",{id:"gadget-lb-canvas",style:"background-color:#ffffff;"}));i.getTitleTextElement()[fcp](fc0("div",{id:"gfc-canvas-title",style:"color:#000000;"})),i.getContentElement()[fcp](h);i.setVisible(fcb);h=fcU(a);var j=fcJb(fcj),k=fcl[fct](j[fcO]*0.7);j={};j.BORDER_COLOR="#cccccc";j.ENDCAP_BG_COLOR="#e0ecff";
j.ENDCAP_TEXT_COLOR="#333333";j.ENDCAP_LINK_COLOR="#0000cc";j.ALTERNATE_BG_COLOR="#ffffff";j.CONTENT_BG_COLOR="#ffffff";j.CONTENT_LINK_COLOR="#0000cc";j.CONTENT_TEXT_COLOR="#333333";j.CONTENT_SECONDARY_LINK_COLOR="#7777cc";j.CONTENT_SECONDARY_TEXT_COLOR="#666666";j.CONTENT_HEADLINE_COLOR="#333333";h.id="gadget-lb-canvas";fco(h,fcl.min(498,k)+"px");h.maxHeight=k;if(h.keepMax){fco(h,k);fcYb(i.getContentElement(),"height",k+35+"px")}h["view-params"]=h["view-params"]||{};h["view-params"].opaque=fcb;h["view-params"].skin=
h["view-params"].skin||{};fcHa(h["view-params"].skin,j);e.render(h);k={};k.id="gadget-signin";k.presentation="canvas";k.site=h.site;k.titleDivId="gfc-canvas-title";k["view-params"]={};k["view-params"].opaque=fcb;k.keepMax=h.keepMax;if(h.securityToken)k.securityToken=h.securityToken;h=fcU(j);h.ALIGNMENT=d?"left":"right";e.Xa(k,h);i.reposition()},fcf,b,c)};fc5[fc].db=function(a,b){fc4.g!=fcc&&fc4.g.yc(a,b)};fc5[fc].Ra=function(a){fc4.g!=fcc&&fc4.g.la(a)};
fc5[fc].Ua=function(a,b,c,d,e,i,h,j,k,l){var f=this.f;a=a+(a[fcC]("?")>=0?"&":"?")+"iframeId="+f;fc4.F(a,b,c,d,e,i,h,j,k,l,this.callback)};
fc9[fc].F=function(a,b,c,d,e,i,h,j,k,l,f){var g=fcJb(fcj);d!=fcc||(d=fcl[fct](g[fcO]*0.7));c!=fcc||(c=fcl[fct](g[fcs]*0.7));var m=[];for(g=0;g<arguments[fcr]&&g<10;g++)m[fcq](arguments[g]);if(!a[0]=="/")fca(new Error("lightbox iframes must be relative to fc server"));var r=this,n=i?fcU(i):{},s=fci(fcl[fct](2147483647*fcl[fcoa]())),o="gfc_lbox_iframe_"+s;fce.rpc.setAuthToken(o,s);if(!b)b=fc4.openSocialSecurityToken;var t=fc4.openSocialSiteId;fc4.Y(function(p){r.lastIframeLightboxOpenArguments=m;var v=
"st="+fch(b)+"&parent="+fch(fc4.S)+"&rpctoken="+fch(s);if(!j){n.iframeId=o;n.iurl=a;a=fcg+"/friendconnect/lightbox"}var q=d-54;fco(n,q);var u='<iframe id="'+o;u+='" width="100%" height="'+q+'" frameborder="0" scrolling="auto"></iframe>';p.setContent(u);if(e){p.setTitle(e);if(l){q=p.getTitleTextElement();fcDb(q,"lightbox-dialog-title-small-text")}}p.setVisible(fcb);k||(n.fcauth=fc4.Ja(t));a+=(a[fcC]("?")>=0?"&":"?")+v+"&communityId="+t;fcAc(o,a,"POST",n,fcc,fcc,fcc)},fcf,f,fcf,c,d)};
fc5[fc].Fa=function(){var a=fc$(this.f);a=fc4.w(a);return a.viewParams};fc5[fc].Ea=function(){return fcuc};fc5[fc].Va=function(a,b){var c=fc$(this.f);c=fc4.w(c);c.viewParams[a]=b};fc9[fc].Nb=function(a,b){fc4.g!=fcc&&fc4.g.Xb(b)};fc9[fc].Ob=function(a,b){fc4.g!=fcc&&fc4.g.Yb(b)};fc5[fc].Ca=function(a,b,c,d){fc4.g!=fcc&&fc4.g.rb(a,b,c,d)};fc9[fc].H=function(a){var b=this.A.Ma(a);a.render(b);this.A.postProcessGadget&&this.A.postProcessGadget(a)};
fc5[fc].signout=function(a){fc4.Wa(fc4.ea(a));fc4.Wa(fc4.ia(a));fc4.Da={};fc4.T();return fcd};fc9[fc].Wa=function(a){var b=fck[fcA].pathname;b=b[fcx]("/");for(var c=0;c<b[fcr];c++){for(var d=new Array(c+1),e=0;e<c+1;e++)d[e]=b[e];fcob(a,d[fcQ]("/")+"/")}};
fc5[fc].ab=function(a){var b=fck[fcy](this.f);if(b&&a>0)fco(b[fcD],a+"px");if((b=fck[fcy](this.f+"_body"))&&a>0)fco(b[fcD],a+"px");if(b=fc$(this.f)){var c=fc4.w(b);if(c){if((b=fck[fcy](c.divId))&&a>0){if(c&&c[fcta]&&c[fcta]<a){a=c[fcta];b[fcD].overflowY="auto"}fco(b[fcD],a+"px")}!c.keepMax&&c.ka()=="canvas"&&fc4.lastLightboxDialog&&fc4.lastLightboxDialog.reposition();fcYb(c.chrome,"visibility","visible")}}};
fc5[fc].setTitle=function(a){var b=fc$(this.f);b=fc4.w(b);if(b=b.titleDivId)fcn(fck[fcy](b),fce[fcK].escapeString(a))};fc5[fc].signin=function(a,b,c){fcmb(fc4.ea(a),b,31104E3,c);fcmb(fc4.ia(a),b,-1,c);fc4.Da[a]=b;fc4.T()};var fcHc=function(a){fcic(a,fcGc)};fc9[fc].ic=function(a,b){b&&this.m(b,a);b={};b.url=fcg+"/friendconnect/gadgets/members.xml";this.render(this.s(a,b))};
...
fc9[fc].Xa=function(a,b){b&&this.m(b,a);b={};b.url=fcg+"/friendconnect/gadgets/signin.xml";fco(b,32);this.render(this.s(a,b))};fc9[fc].fc=function(a,b){b&&this.m(b,a);a.prefs=a.prefs||{};a.sendViewParamsToServer=fcb;a.prefs.hints=fcj.google_hints;b={};b.url=fcg+"/friendconnect/gadgets/ads.xml";fco(b,90);this.render(this.s(a,b))};
fc9[fc].ua=function(a,b){if(a.id){b&&this.m(b,a);a["view-params"]=a["view-params"]||{};a["view-params"].opaque="true";this.g=new fc2(a);this.g.render();b={};b.url=fcg+"/friendconnect/gadgets/friendbar.xml";a.id=this.g.t;fco(a,"1");this.render(this.s(a,b))}};fc9[fc].hc=fc9[fc].ua;fc9[fc].ta=function(a,b){a=a||{};a.url=fcg+"/friendconnect/gadgets/signin.xml";a.site=a.site||fce[fcK][fcB]().site;fco(a,32);this.sa(a,b)};fc9[fc].gc=fc9[fc].ta;fc9[fc].mc=fc9[fc].ra;
fc9[fc].m=function(a,b){var c=b["view-params"];if(!c){c={};b["view-params"]=c}c.skin=a};fc9[fc].s=function(a,b){var c=this.Ta(b,a);if(b["view-params"]){b=b["view-params"];if(a["view-params"])b=this.Ta(b,a["view-params"]);c["view-params"]=b}return c};fc9[fc].jc=function(a,b){b&&this.m(b,a);this.render(a)};fc9[fc].Ta=function(a,b){var c={},d;for(d in b)c[d]=b[d];for(d in a)if(typeof c[d]=="undefined")c[d]=a[d];return c};
...
var fcJc=["ar","dv","fa","iw","he","ku","pa","sd","tk","ug","ur","yi"],fcFc=function(a){a=a;var b=fcd;if(a){a=a[fcx]("_")[0];b=fcrb(fcJc,a)}else b=(a=fc_b(fck[fcna],"direction"))&&a=="rtl";return b};fc5[fc].fb=function(a,b){var c=0,d=fcc;try{var e=fc$(this.f),i=fc4.w(e);d=i.secureToken;c=i.communityId}catch(h){}if(b)c=b;fc4.I(a,c,this.callback,d)};
...
var fcGc=function(a){fc4.G&&fccc(fc4.G,a)},fcKc=function(){fc5[fc].signout(fc4.openSocialSiteId)},fcLc=function(){fcfc(fc4.G)},fcMc=function(a,b){fc$b(a,b)},fcoc=function(){this.o={}};fcoc[fc].register=function(){fce.rpc[fcP]("subscribeEventType",fc5[fc].subscribe);fce.rpc[fcP]("publishEvent",fc5[fc].publish)};fc5[fc].subscribe=function(a){var b=fcDc;b.o[a]=b.o[a]||[];a=b.o[a];a[a[fcr]]={frameId:this}};fcoc[fc].gb=function(a,b,c){var d=this;d.o[b]=d.o[b]||[];b=d.o[b];b[b[fcr]]={container:a,callback:c}};
fc5[fc].publish=function(a){var b=fcDc,c=0;if(this.f)c=fc$(this.f);b.o[a]=b.o[a]||[];b=b.o[a];for(var d=0;d<b[fcr];d++)b[d].container?b[d].callback[fcF](b[d].container,a,c):fce.rpc[fcF](b[d].frameId,a,fcc,a,c)};var fcpc=fcV(fc5[fc].publish,new fc5),fcDc=new fcoc,fc4=new fc9;fc4.Aa(fc4.vb);fcW("google.friendconnect.container",fc4);fcW("google.friendconnect.container.refreshGadgets",fc4.T);fcW("google.friendconnect.container.setParentUrl",fc4.W);fcW("google.friendconnect.container.setServerBase",fc4.X);
...
fcW("google.friendconnect.container.getGadgetSecurityToken",fc4.Eb);fcW("google.friendconnect.container.getGadgetCommunityId",fc4.Db);fcW("google.friendconnect.container.showEmbedDialog",fc4.xc);fcW("google.friendconnect.container.showMemberProfile",fc4.I);fcW("google.friendconnect.requestSignIn",fcGc);fcW("google.friendconnect.requestSignOut",fcKc);fcW("google.friendconnect.requestSettings",fcLc);fcW("google.friendconnect.requestInvite",fcMc);fcW("google.friendconnect.renderSignInButton",fcHc);
fcW("google.friendconnect.container.invokeOpenSocialApiViaIframe",fc4.Pb);fcW("google.friendconnect.container.removeOpenSocialApiViaIframe",fc4.ec);fcW("google.friendconnect.userAgent.WEBKIT",fccb);fcW("google.friendconnect.userAgent.IE",fcY);fcW("google.friendconnect.PeopleSelectorOnChange",fcIc);fcW("google.friendconnect.container.setDateStamp_",fc4.qc);
google.friendconnect.container.setServerBase('http://www.a.friendconnect.gmodules.com/ps/');google.friendconnect.container.setServerVersion('0.545.6');google.friendconnect.container.setApiVersion('0.8');
...
google.friendconnect.container.setDateStamp_('127dba8cd3e');