...
ycWS1=ycRF+' onMouseOver="window.status=\'Minimizam\';return true"'+ycWSC;
ycWS2=ycRF+' onMouseOver="window.status=\'Expandem\';return true"'+ycWSC;
...
if (yvSM){
document.write(ycMM1+yvSMU+ycMM2+'msg.gif'+ycMM3+'Envie-me uma mensagem'+ycMM4);
}
if (yvVP){
document.write(ycMM1+yvVPU+ycMM2+'profile.gif'+ycMM3+'Veja meu perfil'+ycMM4);
}
if (yvnGC){
document.write(ycMM1+yvnGCM+ycMM2+'gc.gif'+ycMM3+'Mensagem para '+yvnMN+ycMM4);
}
...
yfnWM();
if (yvS==0) {
document.write( ycL0+'yl1>'+ycL1+'ym1'+ycL2+'geomid.gif'+ycL3+'><a '+ycOCH+'2)'+ycWS2+'>'+yvM+'</a></td></tr><tr><td align=center><a '+ycOCH+'2)'+ycWS2+'>'+ycL4+'Mais...');
} else {
document.write( ycL0+'yl1>'+ycL1+'ym2'+ycL2+'geodown.gif'+ycL3+'>'+yvM+'</td></tr><tr><td align=center><a '+ycOCH+'0)'+ycWS1+'>'+ycL4+'[Fechar]');
}
yfnWM();
document.write( ycL0+'yl2>'+ycL1+'ym2'+ycL2+'geodown.gif'+ycL3+'>'+yvB+'</td></tr><tr><td align=center><a '+ycOCH+'0)'+ycWS1+'>'+ycL4+'[Fechar]');
yfnWM();
}
function yfnOC(d){
yfnPA();
