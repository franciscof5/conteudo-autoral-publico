...
{
fileLoadingImage : URLBase+'Others/lightbox/images/loading.gif',
fileBottomNavCloseImage : URLBase+'Others/lightbox/images/closelabel.gif',
...
// initialize()
// Constructor runs on completion of the DOM loading. Calls updateImageList and
// then
// the function inserts html at the bottom of the page which is used to display
// the shadow
...
initialize : function()
{
	...
	this.overlayDuration = LightboxOptions.animate ? 0.2 : 0; // shadow fade
	// in/out
	// duration

	// When Lightbox starts it will resize itself from 250 by 250 to the current
	// image dimension.
	// If animations are turned off, it will be hidden as to prevent a flicker
	// of a
...
// onclick
// events to appropriate links. You can rerun after dynamically adding images
// w/ajax.
//
...
changeImage : function(imageNum)
{
	...
	this.prevLink.hide();
	this.nextLink.hide();
	// HACK: Opera9 does not currently support scriptaculous opacity and appear
	// fx
